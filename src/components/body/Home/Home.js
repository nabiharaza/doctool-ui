    ...
    render() {
        return (
            <div className='container-fluid d-flex justify-content-center'>
                <div className='row'>
                    <div className='col-md-4'><Card imgsrc={aruba} title='SME Portal' textContent='hello'/></div>
                    <div className='col-md-4'><Card imgsrc={aruba} title='Make Document' textContent='I am here'/></div>
                    <div className='col-md-4'><Card  imgsrc={aruba} title='Preview Document' textContent='Dummy Dummy Text'/></div>
                </div>
            </div>);
    }
}
